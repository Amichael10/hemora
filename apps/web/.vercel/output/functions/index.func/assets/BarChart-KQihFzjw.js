...
import { forwardRef, useState, useRef, useImperativeHandle, useCallback, useEffect, createContext, useContext, PureComponent, useMemo, useLayoutEffect, isValidElement } from "react";
import { clsx } from "clsx";
import { ak as isStacked, al as isNullish, a4 as getPercentValue, am as isWellBehavedNumber, an as getStackSeriesIdentifier, $ as isNumber, ao as Global, ap as getStringSize, a0 as mathSign, D as DefaultZIndexes, A as resolveDefaultProps, Z as ZIndexLayer, L as Layer, B as svgPropertiesNoEvents, aq as CartesianLabelContextProvider, ar as CartesianLabelFromLabelProp, a1 as svgPropertiesNoEventsFromUnknown, as as isValidTextAnchor, X as adaptEventsOfChild, a6 as getClassNameFromUnknown, a7 as Text, a8 as useAppDispatch, at as noop, au as setRenderedTicks, av as removeRenderedTicks, E as useAppSelector, aw as selectXAxisSettings, ax as selectYAxisSettings, ay as implicitXAxis, az as implicitYAxis, aA as usePlotArea, aB as defaultAxisId, Y as Shape, z as selectChartOffsetInternal, aC as selectAxisViewBox, n as selectChartLayout, aD as selectChartDataWithIndexesIfNotInPanoramaPosition3, aE as selectAxisWithScale, aF as selectTicksOfGraphicalItem, aG as getBandSizeOfAxis, aH as selectUnfilteredCartesianItems, aI as selectRootMaxBarSize, aJ as selectBarGap, aK as selectBarCategoryGap, aL as selectStackGroups, aM as selectRootBarSize, aN as selectCartesianAxisSize, aO as getNormalizedStackId, aP as propsAreEqual, aQ as useIsPanorama, R as RegisterGraphicalItemId, aR as SetLegendPayload, aS as SetCartesianGraphicalItem, y as getTooltipNameProp, G as SetTooltipEntrySettings, aT as useChartLayout, C as findAllByType, K as Cell, g as getValueByDataKey, aU as getBaseValueOfBar, aV as truncateByDomain, aW as getCateCoordinateOfBar, M as selectActiveTooltipIndex, Q as useMouseEnterItemDispatch, T as useMouseLeaveItemDispatch, U as useMouseClickItemDispatch, H as useAnimationId, J as JavascriptAnimate, I as interpolate, _ as LabelListFromLabelProp, aX as CartesianLabelListContextProvider, N as selectActiveTooltipDataKey, aY as isNan, aZ as useCartesianChartLayout, a_ as addXAxis, a$ as replaceXAxis, b0 as removeXAxis, b1 as selectTicksOfAxis, b2 as selectXAxisSize, b3 as selectXAxisPosition, b4 as selectXAxisSettingsNoDefaults, b5 as getAxisTypeBasedOnLayout, b6 as addYAxis, b7 as replaceYAxis, b8 as removeYAxis, b9 as selectYAxisSize, ba as selectYAxisPosition, bb as selectYAxisSettingsNoDefaults, bc as isLabelContentAFunction, bd as updateYAxisWidth, aa as RechartsStoreProvider, ab as ChartDataContextProvider, ac as ReportMainChartProps, ad as ReportEventSettings, ae as ReportChartProps, af as CategoricalChart, ag as initialEventSettingsState, ah as arrayTooltipSearcher } from "./CategoricalChart-DJedIoBC.js";
...
var Ticks = /* @__PURE__ */ forwardRef((props, ref) => {
  ...
  var tickLines = tickLineCoords.map((_ref2) => {
    ...
    }, tickLine && /* @__PURE__ */ React.createElement("line", _extends$6({}, tickLineProps, lineCoord, {
...
var CartesianAxis = /* @__PURE__ */ React.forwardRef((outsideProps, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(CartesianAxisComponent, _extends$6({}, props, {
    ref
  }));
});
...
function SetErrorBarContext(props) {
  var {
    children
  } = props, rest = _objectWithoutProperties$5(props, _excluded$5);
...
var _excluded$3 = ["onMouseEnter", "onMouseLeave", "onClick"], _excluded2$3 = ["value", "background", "tooltipPosition"], _excluded3$2 = ["id"], _excluded4 = ["onMouseEnter", "onClick", "onMouseLeave"];
function _extends$3() {
...
function BarBackground(props) {
  ...
  } = allOtherBarProps, restOfAllOtherProps = _objectWithoutProperties$3(allOtherBarProps, _excluded$3);
  ...
  return /* @__PURE__ */ React.createElement(ZIndexLayer, {
    ...
    var {
      ...
      tooltipPosition
    } = entry, rest = _objectWithoutProperties$3(entry, _excluded2$3);
    ...
    return /* @__PURE__ */ React.createElement(BarRectangle, _extends$3({
...
function BarRectangleWithActiveState(props) {
  ...
  var content = /* @__PURE__ */ React.createElement(BarRectangle, _extends$3({}, baseProps, {
...
function BarRectangleNeverActive(props) {
  ...
  return /* @__PURE__ */ React.createElement(BarRectangle, _extends$3({}, baseProps, {
    name: String(baseProps.name)
  }, entry, {
    isActive: false,
    option: shape,
...
function BarRectangles(_ref3) {
  ...
  var _ref4 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(props)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, {
    id
  } = _ref4, baseProps = _objectWithoutProperties$3(_ref4, _excluded3$2);
  var {
    shape,
    dataKey,
    activeBar
  ...
  var {
    ...
    onClick: onItemClickFromProps,
    onMouseLeave: onMouseLeaveFromProps
  } = props, restOfAllOtherProps = _objectWithoutProperties$3(props, _excluded4);
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, data.map((entry, i) => {
    return /* @__PURE__ */ React.createElement(BarStackClipLayer, _extends$3({
      index: entry.originalDataIndex,
...
function BarFn(outsideProps) {
  ...
  return /* @__PURE__ */ React.createElement(RegisterGraphicalItemId, {
    ...
    zIndex: props.zIndex
  }, /* @__PURE__ */ React.createElement(BarImpl, _extends$3({}, props, {
    id
  })))));
}
...
var XAxisImpl = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(CartesianAxis, _extends$2({}, allOtherProps, restSynchronizedSettings, {
    x: position.x,
    y: position.y,
...
function YAxisImpl(props) {
  ...
  return /* @__PURE__ */ React.createElement(CartesianAxis, _extends$1({}, allOtherProps, restSynchronizedSettings, {
...
export {
  BarChart as B,
  CartesianChart as C,
  GraphicalItemClipPath as G,
  XAxis as X,
  YAxis as Y,
  Bar as a,
  selectYAxisIdFromGraphicalItemId as b,
