...
import { c as createLucideIcon, o as clsx, z as cn, u as useLocation, an as HemoraLoader, J as supabase, a as useToast } from "./AppRouter-yFV4k-aY.js";
...
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle, d as CardDescription } from "./card-44hdj3L3.js";
import { a1 as isNumber, bg as adaptEventHandlers, C as svgPropertiesNoEvents, D as DefaultZIndexes, bh as isClipDot, bi as svgPropertiesAndEventsFromUnknown, Z as ZIndexLayer, L as Layer, F as useAppSelector, O as selectActiveTooltipIndex, bj as useActiveTooltipDataPoints, an as isNullish, a3 as svgPropertiesNoEventsFromUnknown, bk as useChartWidth, bl as useChartHeight, bm as useOffsetInternal, B as resolveDefaultProps, aS as useIsPanorama, bn as selectAxisPropsNeededForCartesianGridTicksGenerator, bo as isPositiveNumber, bp as warn, bq as getCoordinatesOfGrid, br as getTicksOfAxis, c as createSelector, o as selectChartLayout, aF as selectChartDataWithIndexesIfNotInPanoramaPosition3, bs as selectChartBaseValue, aG as selectAxisWithScale, aH as selectTicksOfGraphicalItem, ap as getStackSeriesIdentifier, bt as isCategoricalAxis, aI as getBandSizeOfAxis, aJ as selectUnfilteredCartesianItems, aN as selectStackGroups, aR as propsAreEqual, R as RegisterGraphicalItemId, aT as SetLegendPayload, aU as SetCartesianGraphicalItem, aQ as getNormalizedStackId, z as getTooltipNameProp, H as SetTooltipEntrySettings, av as noop, aV as useChartLayout, bu as useChartName, aC as usePlotArea, h as getValueByDataKey, bv as getCateCoordinateOfLine, I as useAnimationId, a$ as useCartesianChartLayout, J as JavascriptAnimate, M as interpolate, a_ as isNan, a0 as LabelListFromLabelProp, aZ as CartesianLabelListContextProvider, bw as svgPropertiesAndEvents, a7 as Curve, ao as isWellBehavedNumber, aj as arrayTooltipSearcher, ak as ResponsiveContainer, al as Tooltip, N as Cell } from "./CategoricalChart-BygurfAn.js";
...
import { g as getTicks, d as defaultCartesianAxisProps, s as selectXAxisIdFromGraphicalItemId, b as selectYAxisIdFromGraphicalItemId, u as useNeedsClip, G as GraphicalItemClipPath, C as CartesianChart, X as XAxis, Y as YAxis, B as BarChart, a as Bar } from "./BarChart-CUFB5x5j.js";
...
function LineItem(_ref) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    ...
    lineItem = /* @__PURE__ */ reactExports.createElement("line", _extends$1({}, restOfFilteredProps, {
      x1,
      y1,
      x2,
      y2,
...
function CartesianGrid(props) {
  ...
  }), /* @__PURE__ */ reactExports.createElement(HorizontalStripes, _extends$1({}, propsIncludingDefaults, {
    horizontalPoints
  })), /* @__PURE__ */ reactExports.createElement(VerticalStripes, _extends$1({}, propsIncludingDefaults, {
    verticalPoints
  })), /* @__PURE__ */ reactExports.createElement(HorizontalGridLines, _extends$1({}, propsIncludingDefaults, {
    offset,
    horizontalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ reactExports.createElement(VerticalGridLines, _extends$1({}, propsIncludingDefaults, {
    offset,
    verticalPoints,
    xAxis,
    yAxis
...
function BlogTab() {
  ...
  if (editing) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["draft", "published", "archived"].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          size: "sm",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: save, className: "flex-1", children: "Save" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setEditing(null), children: "Cancel" })
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => setEditing({ status: "draft", body_markdown: "" }), className: "w-full", children: "+ New post" }),
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-4", children: "Loading…" }) : posts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-4", children: "No posts yet." }) : posts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border/60 p-3 space-y-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-sm truncate", children: p.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: p.status === "published" ? "default" : "secondary", children: p.status })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", onClick: () => setEditing(p), children: "Edit" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", className: "text-destructive", onClick: () => remove(p.id), children: "Delete" })
      ] })
    ] }, p.id))
  ] });
}
function ProvidersTab() {
  ...
  if (editing) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Name", value: editing.name || "", onChange: (e) => setEditing({ ...editing, name: e.target.value }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Type (hospital, clinic, doctor…)", value: editing.type || "", onChange: (e) => setEditing({ ...editing, type: e.target.value }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "City", value: editing.city || "", onChange: (e) => setEditing({ ...editing, city: e.target.value }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "State", value: editing.state || "", onChange: (e) => setEditing({ ...editing, state: e.target.value }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Country", value: editing.country || "Nigeria", onChange: (e) => setEditing({ ...editing, country: e.target.value }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Phone", value: editing.phone || "", onChange: (e) => setEditing({ ...editing, phone: e.target.value }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: save, className: "flex-1", children: "Save" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setEditing(null), children: "Cancel" })
      ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => setEditing({ verified: true, country: "Nigeria", type: "hospital" }), className: "w-full", children: "+ New provider" }),
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-4", children: "Loading…" }) : items.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border/60 p-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-sm", children: p.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: [p.type, p.city, p.state].filter(Boolean).join(" · ") }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", onClick: () => setEditing(p), children: "Edit" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", className: "text-destructive", onClick: () => remove(p.id), children: "Delete" })
      ] })
...
function SuggestionsTab() {
  ...
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-4", children: "Loading…" });
  if (!items.length) return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-4", children: "No pending suggestions." });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: items.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border/60 p-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-sm", children: s.name }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: [s.type, s.city, s.state, s.country].filter(Boolean).join(" · ") }),
    s.phone && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: s.phone }),
    s.notes && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: s.notes }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", onClick: () => approve(s), children: "Approve" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", className: "text-destructive", onClick: () => reject(s.id), children: "Reject" })
    ] })
  ] }, s.id)) });
}
function UsersTab() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    ...
    users.map((u) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border/60 p-3 flex items-center justify-between gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium truncate", children: u.full_name || "Unnamed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground truncate", children: u.user_id })
      ] }),
      adminIds.has(u.user_id) ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { children: "admin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: "user" })
    ] }, u.user_id)),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground pt-2", children: "Role changes require backend access — contact dev." })
  ] });
}
function DashboardTab() {
  ...
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4", children: [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "h-40 animate-pulse bg-muted/20 border-none shadow-none" }, i)) });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4", children: kpis.map((kpi) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-none shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] bg-card overflow-hidden group hover:scale-[1.02] transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-2.5 rounded-xl ${kpi.bg}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(kpi.icon, { className: `w-5 h-5 ${kpi.color}` }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[9px] font-bold border-none bg-muted/50 uppercase tracking-[0.15em] px-2.5 py-0.5", children: kpi.trend })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold tracking-tight text-foreground", children: kpi.value.toLocaleString() }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground font-bold uppercase tracking-[1px]", children: kpi.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground/60 italic", children: kpi.sub })
      ] })
    ] }) }, kpi.label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-2 border-none shadow-sm bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-6 border-b border-border/40 bg-muted/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-xl font-serif", children: "Community Vitality" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Engagement trends across users and healthcare resources" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex bg-muted/50 p-1 rounded-xl", children: ["Daily", "Weekly", "Monthly"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: t === "Monthly" ? "default" : "ghost", size: "sm", className: "h-7 text-[9px] font-bold uppercase tracking-widest px-4 rounded-lg", children: t }, t)) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "h-[400px] pt-10 px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: stats.userGrowth, margin: { top: 10, right: 30, left: 0, bottom: 0 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "colorUsers", x1: "0", y1: "0", x2: "0", y2: "1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: "hsl(var(--primary))", stopOpacity: 0.2 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: "hsl(var(--primary))", stopOpacity: 0 })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "colorMeds", x1: "0", y1: "0", x2: "0", y2: "1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: "hsl(var(--accent))", stopOpacity: 0.2 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: "hsl(var(--accent))", stopOpacity: 0 })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", vertical: false, stroke: "hsl(var(--border) / 0.4)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            XAxis,
            {
              dataKey: "name",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-none shadow-sm bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-6 border-b border-border/40 bg-muted/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-xl font-serif", children: "Regional Reach" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Provider density by location" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "h-[400px] pt-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: stats.regionalData, layout: "vertical", margin: { left: -20, right: 30 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", horizontal: false, stroke: "hsl(var(--border) / 0.4)" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Bar,
            {
              ...
              radius: [0, 4, 4, 0],
              barSize: 20,
              children: stats.regionalData.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: index % 2 === 0 ? "hsl(var(--primary))" : "hsl(var(--secondary))" }, `cell-${index}`))
            }
          )
        ] }) }) })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-2 border-none shadow-sm bg-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-4 border-b border-border/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg font-serif", children: "Live Operations" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Real-time audit of platform interactions" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "bg-emerald-500/10 text-emerald-600 border-emerald-500/20 gap-1.5 font-bold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" }),
            "Live Stream"
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border/30", children: stats.recentActivity.map((act, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-4 hover:bg-muted/10 transition-all group cursor-default", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${act.type === "user" ? "bg-primary/10" : "bg-accent/10"}`, children: act.type === "user" ? /* @__PURE__ */ jsxRuntimeExports.jsx(UserPlus, { className: "w-5 h-5 text-primary" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-5 h-5 text-accent" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-foreground truncate", children: act.name || "System" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-muted-foreground uppercase tracking-widest", children: act.status })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: act.label })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold text-foreground mb-0.5", children: new Date(act.date).toLocaleTimeString(void 0, { hour: "2-digit", minute: "2-digit" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: new Date(act.date).toLocaleDateString(void 0, { month: "short", day: "numeric" }) })
          ] })
        ] }) }, i)) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 bg-muted/5 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "link", className: "text-[10px] font-bold uppercase tracking-[2px] text-primary h-auto p-0", children: [
          "Access Full Archive ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "w-3 h-3 ml-1" })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-none shadow-sm bg-secondary text-secondary-foreground p-6 rounded-3xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-6 h-6 text-primary animate-pulse" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold uppercase tracking-[2px] opacity-60", children: "System Status" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-lg italic", children: "Operating Optimally" })
            ] })
          ] }),
          ...
          ].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2 border-b border-white/5 last:border-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-widest opacity-60", children: item.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold", children: item.value }) })
          ] }, item.label)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-none shadow-sm bg-card p-6 rounded-3xl border border-border/40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[10px] font-bold uppercase tracking-[2px] text-muted-foreground mb-4", children: "Quick Actions" }),
          ...
          ].map((action) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: `h-auto py-4 flex flex-col gap-2 rounded-2xl border-none ${action.bg} hover:brightness-95 transition-all`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(action.icon, { className: `w-5 h-5 ${action.text}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-widest", children: action.label })
          ] }, action.label)) })
        ] })
      ] })
    ] })
...
function AdminPage() {
  ...
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx(HemoraLoader, {});
  if (!isAdmin) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-10 h-10 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "h-display", children: "Restricted Area" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "body-md", children: "You do not have the necessary privileges to access the Hemora Admin Console. If you believe this is an error, contact your system administrator." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "rounded-full px-8 hover-elevate", onClick: () => setLocation("/dashboard"), children: "Return to Dashboard" })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto pt-12 pb-24 px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-widest text-primary mb-2 block", children: "System Console" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl font-serif tracking-tight", children: "Admin Dashboard" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "rounded-full px-5 hover:shadow-md transition-all", onClick: () => window.location.reload(), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4 mr-2" }),
          " Refresh"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "rounded-full px-5 shadow-sm hover:shadow-md transition-all", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "w-4 h-4 mr-2" }),
          " Export Logs"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "dashboard", className: "space-y-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-0 z-40 bg-background/80 backdrop-blur-md py-4 border-b border-border/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "bg-muted/40 p-1.5 rounded-2xl h-auto flex flex-wrap sm:inline-flex overflow-x-auto max-w-full justify-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "dashboard", className: "rounded-xl px-6 py-2.5 data-[state=active]:bg-card data-[state=active]:shadow-md font-bold uppercase text-[10px] tracking-widest transition-all whitespace-nowrap", children: "Overview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "blog", className: "rounded-xl px-6 py-2.5 data-[state=active]:bg-card data-[state=active]:shadow-md font-bold uppercase text-[10px] tracking-widest transition-all whitespace-nowrap", children: "Blog" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "prov", className: "rounded-xl px-6 py-2.5 data-[state=active]:bg-card data-[state=active]:shadow-md font-bold uppercase text-[10px] tracking-widest transition-all whitespace-nowrap", children: "Providers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "sugg", className: "rounded-xl px-6 py-2.5 data-[state=active]:bg-card data-[state=active]:shadow-md font-bold uppercase text-[10px] tracking-widest transition-all whitespace-nowrap", children: "Suggestions" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "users", className: "rounded-xl px-6 py-2.5 data-[state=active]:bg-card data-[state=active]:shadow-md font-bold uppercase text-[10px] tracking-widest transition-all whitespace-nowrap", children: "Users" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "dashboard", className: "outline-none focus:ring-0 animate-in fade-in duration-500", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardTab, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "blog", className: "outline-none focus:ring-0 animate-in fade-in duration-500", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BlogTab, {}) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "prov", className: "outline-none focus:ring-0 animate-in fade-in duration-500", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProvidersTab, {}) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "sugg", className: "outline-none focus:ring-0 animate-in fade-in duration-500", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SuggestionsTab, {}) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "users", className: "outline-none focus:ring-0 animate-in fade-in duration-500", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UsersTab, {}) }) })
      ] })
    ] })
  ] }) });
}
