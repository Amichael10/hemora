import { A as requireReact, c as reactExports, g as getDefaultExportFromCjs, E as commonjsGlobal, R as React } from "../server.js";
import { l as reactDomExports } from "./router-BY6ex80A.js";
import { aj as requireShim, o as clsx } from "./AppRouter-yFV4k-aY.js";
...
function requireWithSelector_production() {
  ...
  var objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore = shim.useSyncExternalStore, useRef = React2.useRef, useEffect = React2.useEffect, useMemo = React2.useMemo, useDebugValue = React2.useDebugValue;
...
var Surface = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("svg", _extends$f({}, svgPropertiesAndEvents(others), {
...
var Layer = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("g", _extends$e({
    className: layerClass
...
var Symbols = (_ref2) => {
  ...
  if (isNumber(cx) && isNumber(cy) && isNumber(size)) {
    return /* @__PURE__ */ reactExports.createElement("path", _extends$d({}, filteredProps, {
...
function requireIsEqualsSameValueZero() {
  ...
  (function(exports) {
    ...
    exports.isEqualsSameValueZero = isEqualsSameValueZero2;
...
var ResponsiveContainer = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement(SizeDetectorContainer, _extends$c({}, props, {
    width,
    height,
    ref
  }));
...
var DefaultTooltipContent = (props) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("div", _extends$b({
    className: wrapperCN,
    style: finalStyle
...
var Curve = (props) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("path", _extends$a({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
...
var Rectangle = (rectangleProps) => {
  ...
  if (!isUpdateAnimationActive) {
    ...
    return /* @__PURE__ */ reactExports.createElement("path", _extends$8({}, otherPathProps, {
      x: round$1(x2),
      y: round$1(y2),
      width: round$1(width),
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    return /* @__PURE__ */ reactExports.createElement("path", _extends$8({}, otherPathProps2, {
      radius: typeof radius === "number" ? radius : void 0,
      className: layerClass,
...
var Sector = (sectorProps) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("path", _extends$7({}, svgPropertiesAndEvents(props), {
    className: layerClass,
    d: path
  }));
};
...
function Cursor(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(CursorInternal, _extends$6({}, props, {
    offset,
    layout,
    tooltipAxisBandSize,
    chartName
...
var Text = /* @__PURE__ */ reactExports.forwardRef((outsideProps, ref) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("text", _extends$5({}, svgPropertiesAndEvents(textProps), {
    ref,
    x: x2,
    y: y2,
...
var renderRadialLabel = (labelProps, position, label, attrs, viewBox) => {
  ...
  return /* @__PURE__ */ reactExports.createElement("text", _extends$4({}, attrs, {
...
function Label(outerProps) {
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    zIndex: props.zIndex
  }, /* @__PURE__ */ reactExports.createElement(Text, _extends$4({
    ref: labelRef,
...
var parseLabel = (label, viewBox, labelRef) => {
  ...
  if (label === true) {
    return /* @__PURE__ */ reactExports.createElement(Label, _extends$4({
      key: "label-implicit"
    }, commonProps));
  }
  if (isNumOrStr(label)) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(label)) {
    if (label.type === Label) {
      return /* @__PURE__ */ reactExports.cloneElement(label, _objectSpread$4({
        key: "label-implicit"
      }, commonProps));
    }
    return /* @__PURE__ */ reactExports.createElement(Label, _extends$4({
  ...
  if (label && typeof label === "object") {
    return /* @__PURE__ */ reactExports.createElement(Label, _extends$4({}, label, {
      key: "label-implicit"
    }, commonProps));
  }
  return null;
...
function LabelList(_ref2) {
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    ...
    return /* @__PURE__ */ reactExports.createElement(Label, _extends$3({
...
function LabelListFromLabelProp(_ref2) {
  ...
  if (typeof label === "object") {
    return /* @__PURE__ */ reactExports.createElement(LabelList, _extends$3({
      key: "labelList-implicit"
    }, label, {
...
var NonResponsiveDiv = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  if (typeof width === "string" || typeof height === "string") {
    return /* @__PURE__ */ reactExports.createElement(ReadSizeOnceDiv, _extends({}, props, {
      ref
    }));
  }
  if (typeof width === "number" && typeof height === "number") {
    return /* @__PURE__ */ reactExports.createElement(StaticDiv, _extends({}, props, {
      width,
      height,
      ref
    }));
...
export {
  ...
  svgPropertiesNoEvents as C,
  DefaultZIndexes as D,
  findAllByType as E,
  useAppSelector as F,
  SetPolarLegendPayload as G,
  SetTooltipEntrySettings as H,
  useAnimationId as I,
  ...
  interpolate$1 as M,
  Cell as N,
  selectActiveTooltipIndex as O,
  PolarLabelListContextProvider as P,
  selectActiveTooltipDataKey as Q,
  RegisterGraphicalItemId as R,
  SetPolarGraphicalItem as S,
  selectActiveTooltipGraphicalItemId as T,
  useMouseEnterItemDispatch as U,
  useMouseLeaveItemDispatch as V,
  useMouseClickItemDispatch as W,
  DATA_ITEM_GRAPHICAL_ITEM_ID_ATTRIBUTE_NAME as X,
  DATA_ITEM_INDEX_ATTRIBUTE_NAME as Y,
  ZIndexLayer as Z,
  adaptEventsOfChild as _,
  pickAxisId as a,
  useCartesianChartLayout as a$,
  LabelListFromLabelProp as a0,
  isNumber as a1,
  mathSign as a2,
  svgPropertiesNoEventsFromUnknown as a3,
  polarToCartesian as a4,
  getMaxRadius as a5,
  getPercentValue as a6,
  Curve as a7,
  ...
  usePlotArea as aC,
  defaultAxisId as aD,
  selectAxisViewBox as aE,
  selectChartDataWithIndexesIfNotInPanoramaPosition3 as aF,
  selectAxisWithScale as aG,
  selectTicksOfGraphicalItem as aH,
  getBandSizeOfAxis as aI,
  selectUnfilteredCartesianItems as aJ,
  selectRootMaxBarSize as aK,
  selectBarGap as aL,
  selectBarCategoryGap as aM,
  selectStackGroups as aN,
  selectRootBarSize as aO,
  selectCartesianAxisSize as aP,
  getNormalizedStackId as aQ,
  propsAreEqual as aR,
  useIsPanorama as aS,
  SetLegendPayload as aT,
  SetCartesianGraphicalItem as aU,
  useChartLayout as aV,
  getBaseValueOfBar as aW,
  truncateByDomain as aX,
  getCateCoordinateOfBar as aY,
  CartesianLabelListContextProvider as aZ,
  isNan as a_,
  ...
  ResponsiveContainer as ak,
  Tooltip as al,
  isStacked as am,
  isNullish as an,
  isWellBehavedNumber as ao,
  getStackSeriesIdentifier as ap,
  Global as aq,
  getStringSize as ar,
  CartesianLabelContextProvider as as,
  CartesianLabelFromLabelProp as at,
  isValidTextAnchor as au,
  noop$2 as av,
  setRenderedTicks as aw,
  removeRenderedTicks as ax,
  selectXAxisSettings as ay,
  selectYAxisSettings as az,
  combineGraphicalItemsSettings as b,
  addXAxis as b0,
  replaceXAxis as b1,
  removeXAxis as b2,
  selectTicksOfAxis as b3,
  selectXAxisSize as b4,
  selectXAxisPosition as b5,
  selectXAxisSettingsNoDefaults as b6,
  getAxisTypeBasedOnLayout as b7,
  addYAxis as b8,
  replaceYAxis as b9,
  removeYAxis as ba,
  selectYAxisSize as bb,
  selectYAxisPosition as bc,
  selectYAxisSettingsNoDefaults as bd,
  isLabelContentAFunction as be,
  updateYAxisWidth as bf,
  adaptEventHandlers as bg,
  isClipDot as bh,
  svgPropertiesAndEventsFromUnknown as bi,
  useActiveTooltipDataPoints as bj,
  useChartWidth as bk,
  useChartHeight as bl,
  useOffsetInternal as bm,
  selectAxisPropsNeededForCartesianGridTicksGenerator as bn,
  isPositiveNumber as bo,
  warn as bp,
  getCoordinatesOfGrid as bq,
  getTicksOfAxis as br,
  selectChartBaseValue as bs,
  isCategoricalAxis as bt,
  useChartName as bu,
  getCateCoordinateOfLine as bv,
  svgPropertiesAndEvents as bw,
  createSelector as c,
