...
import { u as useLocalStorage, D as DEFAULT_HOSPITAL_CHECKLIST, H as HOSPITAL_CHECKLIST_KEY } from "./localPrefs-DxdGpGlb.js";
import { j as jsPDF } from "./jspdf.node.min-Ba6FWgAB.js";
import { h as hemoraLogo } from "./Logo-qOo-96Vk.js";
import { E as l40, a as FX1, ae as u11, m as m01 } from "./index-D2ZfvGdl.js";
...
function HospitalChecklist() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MobileAppShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubPageHeader, { title: "Hospital checklist", back: "/settings" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center pt-2 pb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-2xl bg-primary/10 text-primary flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(l40, { size: 36 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs leading-relaxed", children: "Use this checklist to prepare for your hospital visit. Check off items as you complete them." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 px-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground", children: "Checklist" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 px-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-primary transition-all duration-300", style: { width: `${progressPct}%` } }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card rounded-2xl border border-border/60 overflow-hidden divide-y divide-border/60 mb-5", children: items.map((item) => {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: isOn && /* @__PURE__ */ jsxRuntimeExports.jsx(FX1, { size: 16 })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `block text-sm font-medium ${isOn ? "text-foreground" : "text-foreground"}`, children: item.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs text-muted-foreground mt-0.5", children: item.description })
              ] })
            ]
          },
          item.id
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 bg-primary/5 border border-primary/15 rounded-xl p-3.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(u11, { size: 16, className: "text-primary mt-0.5 shrink-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground leading-relaxed", children: "Bring this checklist with you to your appointment." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(m01, { size: 16 }),
            " Share as PDF"
          ]
        }
      )
