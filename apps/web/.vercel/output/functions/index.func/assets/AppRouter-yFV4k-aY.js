import { A as requireReact, c as reactExports, R as React, q as jsxRuntimeExports, p as React$1 } from "../server.js";
import { S as Subscribable, p as pendingThenable, r as resolveQueryBoolean, s as shallowEqualObjects, a as resolveStaleTime, n as noop$1, e as environmentManager, i as isValidTimeout, t as timeUntilStale, b as timeoutManager, f as focusManager, c as fetchState, d as replaceData, g as notifyManager, h as hashKey, j as getDefaultState, k as shouldThrowError, u as useQueryClient, l as reactDomExports, R as ReactDOM } from "./router-BY6ex80A.js";
...
var ensureSuspenseTimers = (defaultedOptions) => {
  if (defaultedOptions.suspense) {
    ...
    const clamp3 = (value) => value === "static" ? value : Math.max(value ?? MIN_SUSPENSE_TIME_MS, MIN_SUSPENSE_TIME_MS);
...
const useInsertionEffect$1 = useBuiltinInsertionEffect || useIsomorphicLayoutEffect;
const useEvent = (fn) => {
...
const useSearch$1 = ({ ssrSearch } = {}) => useLocationProperty(
  currentSearch,
...
const Router = ({ children, ...props }) => {
  ...
  for (let k2 in parent) {
    ...
    next[k2] = option;
    if (option !== parent[k2] || option !== value[k2]) value = next;
  }
...
function createCollection(name) {
  ...
  const CollectionItemSlot = React$1.forwardRef(
    (props, forwardedRef) => {
      ...
      React$1.useEffect(() => {
        context3.itemMap.set(ref, { ref, ...itemData });
...
var ToastViewport$1 = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = reactExports.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref, context3.onViewportChange);
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      VisuallyHidden,
      {
        ...
        onFocus: (event) => {
          ...
          const isFocusFromOutsideViewport = !context3.viewport?.contains(prevFocusedElement);
...
var ToastImpl = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    const handleClose = useCallbackRef(() => {
      ...
      if (isFocusInToast) context3.viewport?.focus();
      onClose();
    });
...
const createConfigUtils = (config3) => ({
  ...
  postfixLookupClassGroupIds: createPostfixLookupClassGroupIds(config3),
  ...createClassGroupUtils(config3)
});
const createPostfixLookupClassGroupIds = (config3) => {
  const lookup = /* @__PURE__ */ Object.create(null);
  const classGroupIds = config3.postfixLookupClassGroups;
  if (classGroupIds) {
...
var TooltipTrigger = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = reactExports.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref, context3.onTriggerChange);
...
var TooltipPortal = (props) => {
  ...
  const context3 = useTooltipContext(PORTAL_NAME, __scopeTooltip);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PortalProvider, { scope: __scopeTooltip, forceMount, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Presence, { present: forceMount || context3.open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$1, { asChild: true, container, children }) }) });
};
    ...
    reactExports.useEffect(() => {
      if (context3.trigger) {
        const handleScroll = (event) => {
          const target = event.target;
          if (target?.contains(context3.trigger)) onClose();
        };
...
function AuthProvider({ children }) {
  ...
  const signInWithPassword = reactExports.useCallback(async (email, password) => {
    const { error } = await supabase.auth.signInWithPassword({ email, password });
    return { error: error?.message ?? null };
  }, []);
  const signUpWithPassword = reactExports.useCallback(async (email, password) => {
...
const mapProfile = (r2) => r2 && {
  id: r2.id,
  fullName: r2.full_name ?? "",
  setupFor: r2.setup_for,
  country: r2.country,
  state: r2.state,
  dateOfBirth: r2.date_of_birth,
  gender: r2.gender,
  scdStatus: r2.scd_status,
  sex: r2.sex,
  bloodType: r2.blood_type,
  genotype: r2.genotype,
  heightCm: r2.height_cm,
  weightKg: r2.weight_kg,
  allergies: r2.allergies,
...
const mapMed = (r2) => ({
  ...
  reminderTime: r2.reminder_time,
  reminderEnabled: r2.reminder_enabled,
  status: r2.status,
  notes: r2.notes,
  refillReminderDays: r2.refill_reminder_days ?? null,
  startDate: r2.start_date ?? null,
  nextRefillDate: r2.next_refill_date ?? null,
  createdAt: r2.created_at
});
const mapMedLog = (r2) => ({
  id: r2.id,
  medicationId: r2.medication_id,
  status: r2.status,
  scheduledAt: r2.scheduled_at ?? r2.taken_at,
  takenAt: r2.taken_at
});
const mapCrisis = (r2) => ({
  id: r2.id,
  occurredAt: r2.occurred_at,
  painLevel: r2.pain_level,
  painLocations: r2.pain_locations ?? [],
  triggers: r2.triggers ?? [],
  whatHelped: r2.what_helped ?? [],
  hospitalVisit: r2.hospital_visit ?? false
});
const mapRecord = (r2) => ({
  id: r2.id,
  documentTitle: r2.document_title,
  hospitalClinic: r2.hospital_clinic,
  type: r2.type,
  status: r2.status,
  dateOfRecord: r2.date_of_record,
  labName: r2.lab_name ?? null,
  fileUrl: r2.file_url ?? null,
  notes: r2.notes ?? null
});
const mapProvider = (r2) => ({
  id: r2.id,
  name: r2.name,
  type: r2.type,
  specialty: r2.specialty,
  hospital: r2.hospital,
  phone: r2.phone,
  email: r2.email,
  address: r2.address,
  city: r2.city,
  state: r2.state,
  country: r2.country,
  website: r2.website ?? null,
  latitude: r2.latitude ?? null,
  longitude: r2.longitude ?? null,
  services: r2.services ?? [],
  saved: r2.saved ?? false,
  verified: r2.verified ?? false
});
const mapEC = (r2) => ({
  id: r2.id,
  fullName: r2.full_name ?? r2.name,
  name: r2.name,
  phone: r2.phone,
...
const mapTransfusion = (r2) => ({
  id: r2.id,
  occurredAt: r2.occurred_at,
  unitsCount: r2.units_count ?? 1,
  transfusionType: r2.transfusion_type ?? "simple",
  reactionLogged: r2.reaction_logged ?? false,
  reactionDetails: r2.reaction_details ?? null,
  hospitalId: r2.hospital_id ?? null,
  hemoglobinPre: r2.hemoglobin_pre ?? null,
  hemoglobinPost: r2.hemoglobin_post ?? null,
  notes: r2.notes ?? null,
  createdAt: r2.created_at
});
const mapAppointment = (r2) => ({
  id: r2.id,
  title: r2.title,
  description: r2.description ?? null,
  appointmentAt: r2.appointment_at,
  providerId: r2.provider_id ?? null,
  status: r2.status ?? "scheduled",
  notes: r2.notes ?? null,
  createdAt: r2.created_at
});
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (uid) {
        ...
        savedIds = new Set((savedRows ?? []).map((r2) => r2.provider_id));
      }
      const { data, error } = await q;
      if (error) throw new ApiError(error.message);
      let rows = (data ?? []).map((r2) => ({
        ...mapProvider(r2),
        saved: savedIds.has(r2.id)
      }));
      if (args?.saved) rows = rows.filter((r2) => r2.saved);
      return rows;
    }
  });
};
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const latestVitals = vitals && vitals.length > 0 ? {
        temp: vitals.find((r2) => r2.type === "temperature")?.value ?? null,
        oxygen: vitals.find((r2) => r2.type === "spo2")?.value ?? null,
...
const ProfileContext = reactExports.createContext(void 0);
const FALLBACK_PROFILE_ID = "";
function ProfileProvider({ children }) {
  const { user, loading: authLoading } = useAuth();
  const [profileId, setProfileId] = reactExports.useState(FALLBACK_PROFILE_ID);
  const [activeProfileId, setActiveProfileId] = reactExports.useState(FALLBACK_PROFILE_ID);
  const [familyMembers, setFamilyMembers] = reactExports.useState([]);
  const [resolving, setResolving] = reactExports.useState(true);
...
function useProfile() {
  const context3 = reactExports.useContext(ProfileContext);
  if (context3 === void 0) {
...
var _config = {
  ...
  var a = !v ? _colorLookup.black : _isNumber(v) ? [v >> 16, v >> 8 & _255, v & _255] : 0, r2, g, b, h, s, l, max2, min2, d, wasHSL;
  if (!a) {
    if (v.substr(-1) === ",") {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            "aria-hidden": "true",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M196.239 48.8801C199.167 48.2923 207.971 48.7556 211.086 48.9798C207.818 50.0075 200.511 51.014 196.537 51.8535C186.083 54.039 175.894 57.342 166.147 61.7058C131.436 77.4427 104.458 106.409 91.2222 142.153C77.9194 177.988 79.584 217.667 95.8409 252.261C111.186 286.004 139.248 312.309 173.906 325.441C213.469 340.018 261.564 333.893 294.621 307.113C311.56 293.39 327.301 273.891 334.887 253.321C333.357 270.329 326.743 285.443 318.139 300.01C293.021 339.335 252.893 365.172 206.008 368.759C166.852 371.625 128.18 358.691 98.6259 332.844C66.727 304.978 46.9983 265.733 43.6613 223.505C36.9859 134.144 107.362 55.4608 196.239 48.8801Z", fill: "#9D1F2E" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M158.897 174.616C159.671 174.539 160.446 174.486 161.223 174.457C182.932 173.697 201.914 192.914 204.874 213.606C205.361 217.012 205.438 220.739 205.558 224.188C200.78 223.229 196.71 222.382 191.735 222.582C169.151 223.512 153.609 246.044 154.755 267.497C155.794 286.951 165.474 299.457 179.084 312.023L184.041 316.145C151.423 307.221 120.219 277.103 115.236 242.942C110.659 211.559 125.4 180.04 158.897 174.616Z", fill: "#0C3F46" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M249.968 216.848C285.587 214.262 294.033 254.2 280.639 280.178C269.645 301.499 252.206 310.9 230.323 317.803C223.028 319.37 217.848 319.218 210.432 319.261C221.593 309.143 235.282 301.173 238.526 284.61C241.332 270.284 236.5 261.179 221.943 258.219C222.321 239.847 230.36 220.711 249.968 216.848Z", fill: "#B78D54" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M184.054 123.836C198.016 120.674 211.88 129.491 214.94 143.478C218 157.464 209.085 171.267 195.079 174.227C181.216 177.157 167.585 168.35 164.556 154.505C161.528 140.661 170.234 126.965 184.054 123.836Z", fill: "#0C3F46" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M182.208 270.737C192.496 270.584 194.115 272.241 199.999 280.227C203.342 275.457 207.55 271.212 213.66 270.675C220.568 270.068 225.177 276.369 225.363 282.703C225.606 290.995 220.168 298.004 214.86 303.797C210.559 308.275 204.28 313.533 198.906 316.513C189.139 310.414 177.95 298.613 174.12 287.754C171.411 280.074 174.26 273.143 182.208 270.737Z", fill: "#B78D54" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M245.062 168.379C256.842 165.659 268.586 173.045 271.239 184.842C273.892 196.639 266.441 208.343 254.632 210.93C242.915 213.497 231.326 206.117 228.694 194.413C226.062 182.709 233.376 171.077 245.062 168.379Z", fill: "#B78D54" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M197.906 237.153C216.283 236.028 221.484 262.99 201.244 267.563C184.078 269.695 177.917 241.436 197.906 237.153Z", fill: "#B78D54" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-lg text-secondary tracking-[-0.2px]", children: label }),
...
function RequireAuth({ children }) {
  ...
  if (loading || !user) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(HemoraLoader, { sublabel: loading ? "Getting things ready…" : "Redirecting to sign in…" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
}
const Splash = reactExports.lazy(() => import("./splash-9Evjdk9o.js"));
const Onboarding = reactExports.lazy(() => import("./onboarding-ymcB718Z.js"));
const Dashboard = reactExports.lazy(() => import("./dashboard-BtWdTp_k.js"));
const Crisis = reactExports.lazy(() => import("./crisis-Dh0s62nJ.js"));
const CrisisInsights = reactExports.lazy(() => import("./crisis-insights-DN6PGsRa.js"));
const CrisisShare = reactExports.lazy(() => import("./crisis-share-TIFyRpvV.js"));
const CrisisDetail = reactExports.lazy(() => import("./crisis-detail-DqWGXoCJ.js"));
const Meds = reactExports.lazy(() => import("./meds-DzsmC2rb.js"));
const MedForm = reactExports.lazy(() => import("./med-form-B5J9TFJ2.js"));
const MedDetail = reactExports.lazy(() => import("./med-detail-CdQCnxfl.js"));
const Records = reactExports.lazy(() => import("./records-BFDRG8Jw.js"));
const RecordForm = reactExports.lazy(() => import("./record-form-BpdpHGn8.js"));
const RecordDetail = reactExports.lazy(() => import("./record-detail-YZsq8OCW.js"));
const Directory = reactExports.lazy(() => import("./directory-DMlzTfuT.js"));
const DirectoryDetail = reactExports.lazy(() => import("./directory-detail-C10zbOc8.js"));
const Emergency = reactExports.lazy(() => import("./emergency-B7DxSn16.js"));
const AuthCallback = reactExports.lazy(() => import("./auth-callback-DEC-IQKi.js"));
const Profile = reactExports.lazy(() => import("./profile-jYZTdRL-.js"));
const ProfileEdit = reactExports.lazy(() => import("./profile-edit-BiOcGH3K.js"));
const NotFound = reactExports.lazy(() => import("./not-found-ChFQs7SD.js"));
const Login = reactExports.lazy(() => import("./login-SdazdMc7.js"));
const Signup = reactExports.lazy(() => import("./signup-BdlOZVIT.js"));
const ForgotPassword = reactExports.lazy(() => import("./forgot-password-g6y7KPCF.js"));
const ResetPassword = reactExports.lazy(() => import("./reset-password-C3pm50cW.js"));
const Settings = reactExports.lazy(() => import("./settings-DV5ULDx4.js"));
const Contacts = reactExports.lazy(() => import("./contacts-V1jGdIYY.js"));
const Notifications = reactExports.lazy(() => import("./notifications-acf8bF9K.js"));
const NotificationSettings = reactExports.lazy(() => import("./notification-settings-Cq4YMFcS.js"));
const AmbulancePage = reactExports.lazy(() => import("./ambulance-DEs0Scph.js"));
const HospitalChecklist = reactExports.lazy(() => import("./hospital-checklist-kuUs0x0r.js"));
const GenotypeChecker = reactExports.lazy(() => import("./genotype-checker-BgvYMZuW.js"));
const Family = reactExports.lazy(() => import("./family-YFDgSXZX.js"));
const FamilyAdd = reactExports.lazy(() => import("./family-add-CmgBR5WL.js"));
const SchoolLetter = reactExports.lazy(() => import("./school-letter-Cfw2NGYl.js"));
const Resources = reactExports.lazy(() => import("./resources-B2tFc-AK.js"));
const ResourceDetail = reactExports.lazy(() => import("./resource-detail-AlROGEGA.js"));
const Brand = reactExports.lazy(() => import("./brand-DuZX-hsg.js"));
const Admin = reactExports.lazy(() => import("./admin-DQfyOmpE.js"));
const BlogIndex = reactExports.lazy(() => import("./blog-jWtBmbQU.js"));
const BlogPost = reactExports.lazy(() => import("./blog-post-CE4_PKof.js"));
const Vitals = reactExports.lazy(() => import("./vitals-qG1tGvJW.js"));
const Hydration = reactExports.lazy(() => import("./hydration-CEv8tmFK.js"));
const VitalsForm = reactExports.lazy(() => import("./vitals-form-BW0K97dB.js"));
const Transfusion = reactExports.lazy(() => import("./transfusion-DJ9cgvU7.js"));
const TransfusionForm = reactExports.lazy(() => import("./transfusion-form-Mdwyf77-.js"));
const TransfusionDetail = reactExports.lazy(() => import("./transfusion-detail-BSpDgF0s.js"));
const TransfusionHistory = reactExports.lazy(() => import("./transfusion-history-DoQN7_aC.js"));
const IronMonitoring = reactExports.lazy(() => import("./iron-monitoring-BgftehEw.js"));
const Appointments = reactExports.lazy(() => import("./appointments-DTgoQyzY.js"));
const AppointmentForm = reactExports.lazy(() => import("./appointments-form-bt08JIIJ.js"));
const About = reactExports.lazy(() => import("./info-BudqqeT4.js").then((m) => ({ default: m.About })));
const Help = reactExports.lazy(() => import("./info-BudqqeT4.js").then((m) => ({ default: m.Help })));
const Privacy = reactExports.lazy(() => import("./info-BudqqeT4.js").then((m) => ({ default: m.Privacy })));
const Terms = reactExports.lazy(() => import("./info-BudqqeT4.js").then((m) => ({ default: m.Terms })));
function RootRedirect() {
  const { user, loading } = useAuth();
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx(HemoraLoader, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Redirect, { to: user ? "/dashboard" : "/login" });
}
const protect = (Component) => {
  const Wrapped = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Component, { ...props }) });
  Wrapped.displayName = `Protected(${Component.displayName || Component.name || "Component"})`;
  return Wrapped;
};
function Routes() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(HemoraLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Switch, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", component: RootRedirect }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/welcome", component: Splash }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/onboarding", component: Onboarding }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/login", component: Login }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/signup", component: Signup }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/forgot-password", component: ForgotPassword }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/reset-password", component: ResetPassword }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/auth/callback", component: AuthCallback }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/dashboard", component: protect(Dashboard) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/crisis", component: protect(Crisis) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/crisis/insights", component: protect(CrisisInsights) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/crisis/share", component: protect(CrisisShare) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/crisis/:id", component: protect(CrisisDetail) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/meds", component: protect(Meds) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/meds/new", component: protect(MedForm) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/meds/:id/edit", component: protect(MedForm) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/meds/:id", component: protect(MedDetail) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/records", component: protect(Records) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/records/new", component: protect(RecordForm) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/records/:id/edit", component: protect(RecordForm) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/records/:id", component: protect(RecordDetail) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/vitals", component: protect(Vitals) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/hydration", component: protect(Hydration) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/vitals/new", component: protect(VitalsForm) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/transfusion", component: protect(Transfusion) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/transfusion/new", component: protect(TransfusionForm) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/transfusion/detail", component: protect(TransfusionDetail) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/transfusion/history", component: protect(TransfusionHistory) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/iron-monitoring", component: protect(IronMonitoring) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/appointments", component: protect(Appointments) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/appointments/new", component: protect(AppointmentForm) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/directory", component: protect(Directory) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/directory/:id", component: protect(DirectoryDetail) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/emergency", component: Emergency }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/profile", component: protect(Profile) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/profile/edit", component: protect(ProfileEdit) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/settings", component: protect(Settings) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/settings/contacts", component: protect(Contacts) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/notifications", component: protect(Notifications) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/settings/notifications", component: protect(NotificationSettings) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/settings/ambulance", component: protect(AmbulancePage) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/settings/hospital-checklist", component: protect(HospitalChecklist) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/genotype-checker", component: GenotypeChecker }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/family", component: protect(Family) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/family/add", component: protect(FamilyAdd) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/school-letter", component: protect(SchoolLetter) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/resources", component: Resources }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/resources/:id", component: ResourceDetail }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/brand", component: Brand }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/admin", component: protect(Admin) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/blog", component: BlogIndex }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/blog/:slug", component: BlogPost }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/help", component: Help }),
...
function AppRouter() {
  ...
  if (!mounted) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[100dvh] w-full bg-secondary" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProfileProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TooltipProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Router, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Routes, {}) }),
...
export {
  Root2 as $,
  AppRouter as A,
  useListCareRecords as B,
  CreateProfileBodySetupFor as C,
  useCreateCareRecord as D,
  CreateCareRecordBodyType as E,
  useGetCareRecord as F,
  useUpdateCareRecord as G,
  useDeleteCareRecord as H,
  CreateCareRecordBodyStatus as I,
  supabase as J,
  useUpdateProvider as K,
  Link as L,
  useUpdateProfile as M,
  useListProviders as N,
  getListProvidersQueryKey as O,
  getGetProfileQueryKey as P,
  useCreateProviderSuggestion as Q,
  useGetProvider as R,
  useListEmergencyContacts as S,
  getListEmergencyContactsQueryKey as T,
  getProfileByUser as U,
  ApiError as V,
  composeRefs as W,
  cva as X,
  useMutation as Y,
  ...
  useToast as a,
  useComposedRefs as a0,
  useLayoutEffect2 as a1,
  Primitive as a2,
  createPopperScope as a3,
  createCollection as a4,
  VISUALLY_HIDDEN_STYLES as a5,
  Anchor as a6,
  composeEventHandlers as a7,
  Portal$1 as a8,
  createContextScope as a9,
  useCallbackRef as aa,
  DismissableLayer as ab,
  createSlot as ac,
  Content as ad,
  Arrow as ae,
  Presence as af,
  createContext2 as ag,
  X as ah,
  shimExports as ai,
  requireShim as aj,
  useSize as ak,
  useCreateEmergencyContact as al,
  useDeleteEmergencyContact as am,
  HemoraLoader as an,
  useListVitalsLogs as ao,
  getListVitalsLogsQueryKey as ap,
  useCreateVitalsLog as aq,
  useSearch as ar,
  useListTransfusionLogs as as,
  getListTransfusionLogsQueryKey as at,
  useCreateTransfusionLog as au,
  useCreateAppointment as av,
  useCreateProfile as b,
  createLucideIcon as c,
  useProfile as d,
  useAuth as e,
  useGetProfile as f,
  useGetDashboardSummary as g,
  useListMedications as h,
  useListMedicationLogs as i,
  useCreateMedicationLog as j,
  CreateMedicationLogBodyStatus as k,
  useListCrisisLogs as l,
  useCreateCrisisLog as m,
  CrisisLogPainLevel as n,
  clsx as o,
  getListCrisisLogsQueryKey as p,
  useRoute as q,
  useGetCrisisLog as r,
  useDeleteCrisisLog as s,
  useGetMedication as t,
  useLocation as u,
  useCreateMedication as v,
  useUpdateMedication as w,
  useDeleteMedication as x,
  CreateMedicationBodyStatus as y,
  cn as z
};
