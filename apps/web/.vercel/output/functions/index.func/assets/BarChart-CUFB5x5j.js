import { c as reactExports, i as invariant } from "../server.js";
import { o as clsx } from "./AppRouter-yFV4k-aY.js";
import { am as isStacked, an as isNullish, a6 as getPercentValue, ao as isWellBehavedNumber, ap as getStackSeriesIdentifier, a1 as isNumber, aq as Global, ar as getStringSize, a2 as mathSign, D as DefaultZIndexes, B as resolveDefaultProps, Z as ZIndexLayer, L as Layer, C as svgPropertiesNoEvents, as as CartesianLabelContextProvider, at as CartesianLabelFromLabelProp, K as get, a3 as svgPropertiesNoEventsFromUnknown, au as isValidTextAnchor, _ as adaptEventsOfChild, a8 as getClassNameFromUnknown, a9 as Text, aa as useAppDispatch, av as noop, aw as setRenderedTicks, ax as removeRenderedTicks, F as useAppSelector, ay as selectXAxisSettings, az as selectYAxisSettings, aA as implicitXAxis, aB as implicitYAxis, aC as usePlotArea, aD as defaultAxisId, $ as Shape, c as createSelector, A as selectChartOffsetInternal, aE as selectAxisViewBox, o as selectChartLayout, aF as selectChartDataWithIndexesIfNotInPanoramaPosition3, aG as selectAxisWithScale, aH as selectTicksOfGraphicalItem, aI as getBandSizeOfAxis, aJ as selectUnfilteredCartesianItems, aK as selectRootMaxBarSize, aL as selectBarGap, aM as selectBarCategoryGap, aN as selectStackGroups, aO as selectRootBarSize, aP as selectCartesianAxisSize, aQ as getNormalizedStackId, aR as propsAreEqual, aS as useIsPanorama, R as RegisterGraphicalItemId, aT as SetLegendPayload, aU as SetCartesianGraphicalItem, z as getTooltipNameProp, H as SetTooltipEntrySettings, aV as useChartLayout, E as findAllByType, N as Cell, h as getValueByDataKey, aW as getBaseValueOfBar, aX as truncateByDomain, aY as getCateCoordinateOfBar, O as selectActiveTooltipIndex, U as useMouseEnterItemDispatch, V as useMouseLeaveItemDispatch, W as useMouseClickItemDispatch, I as useAnimationId, J as JavascriptAnimate, M as interpolate, a0 as LabelListFromLabelProp, aZ as CartesianLabelListContextProvider, Q as selectActiveTooltipDataKey, a_ as isNan, a$ as useCartesianChartLayout, b0 as addXAxis, b1 as replaceXAxis, b2 as removeXAxis, b3 as selectTicksOfAxis, b4 as selectXAxisSize, b5 as selectXAxisPosition, b6 as selectXAxisSettingsNoDefaults, b7 as getAxisTypeBasedOnLayout, b8 as addYAxis, b9 as replaceYAxis, ba as removeYAxis, bb as selectYAxisSize, bc as selectYAxisPosition, bd as selectYAxisSettingsNoDefaults, be as isLabelContentAFunction, bf as updateYAxisWidth, ac as RechartsStoreProvider, ad as ChartDataContextProvider, ae as ReportMainChartProps, af as ReportEventSettings, ag as ReportChartProps, ah as CategoricalChart, ai as initialEventSettingsState, aj as arrayTooltipSearcher } from "./CategoricalChart-BygurfAn.js";
...
function BarRectangle(props) {
  return /* @__PURE__ */ reactExports.createElement(Shape, _extends$5({
    shapeType: "rectangle",
...
function BarBackground(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    ...
    return /* @__PURE__ */ reactExports.createElement(BarRectangle, _extends$3({
...
function BarRectangleWithActiveState(props) {
  ...
  var content = /* @__PURE__ */ reactExports.createElement(BarRectangle, _extends$3({}, baseProps, {
...
function BarRectangleNeverActive(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(BarRectangle, _extends$3({}, baseProps, {
    name: String(baseProps.name)
  }, entry, {
    isActive: false,
    option: shape,
...
function BarRectangles(_ref3) {
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, data.map((entry, i) => {
    return /* @__PURE__ */ reactExports.createElement(BarStackClipLayer, _extends$3({
      index: entry.originalDataIndex,
...
function BarImpl(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(SetErrorBarContext, {
    ...
    errorBarOffset
  }, /* @__PURE__ */ reactExports.createElement(BarWithState, _extends$3({}, props, {
    layout,
    needClip,
    data: rects,
    xAxisId,
...
function BarFn(outsideProps) {
  ...
  return /* @__PURE__ */ reactExports.createElement(RegisterGraphicalItemId, {
    ...
    zIndex: props.zIndex
  }, /* @__PURE__ */ reactExports.createElement(BarImpl, _extends$3({}, props, {
    id
  })))));
}
