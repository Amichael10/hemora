...
import { o as clsx, d as useProfile, a as useToast, l as useListCrisisLogs, p as getListCrisisLogsQueryKey, f as useGetProfile, L as Link } from "./AppRouter-yFV4k-aY.js";
...
import { j as UH1 } from "./index-D2ZfvGdl.js";
import { c as createSelector, p as pickAxisType, a as pickAxisId, i as itemAxisPredicate, s as selectBaseAxis, b as combineGraphicalItemsSettings, d as combineGraphicalItemsData, e as selectChartDataAndAlwaysIgnoreIndexes, f as combineDisplayedData, g as combineAppliedValues, h as getValueByDataKey, j as selectAllErrorBarSettings, k as selectChartDataSliceIgnoringIndexes, l as combineDomainOfAllAppliedNumericalValuesIncludingErrorValues, m as selectDomainDefinition, n as selectDomainFromUserPreference, o as selectChartLayout, q as combineNumericalDomain, r as selectStackOffsetType, t as combineAxisDomain, u as selectRenderableAxisSettings, v as selectRealScaleType, w as combineNiceTicks, x as combineAxisDomainWithNiceTicks, y as combineCheckedDomain, z as getTooltipNameProp, A as selectChartOffsetInternal, B as resolveDefaultProps, C as svgPropertiesNoEvents, R as RegisterGraphicalItemId, S as SetPolarGraphicalItem, D as DefaultZIndexes, E as findAllByType, F as useAppSelector, G as SetPolarLegendPayload, L as Layer, Z as ZIndexLayer, H as SetTooltipEntrySettings, I as useAnimationId, J as JavascriptAnimate, K as get, M as interpolate, N as Cell, P as PolarLabelListContextProvider, O as selectActiveTooltipIndex, Q as selectActiveTooltipDataKey, T as selectActiveTooltipGraphicalItemId, U as useMouseEnterItemDispatch, V as useMouseLeaveItemDispatch, W as useMouseClickItemDispatch, X as DATA_ITEM_GRAPHICAL_ITEM_ID_ATTRIBUTE_NAME, Y as DATA_ITEM_INDEX_ATTRIBUTE_NAME, _ as adaptEventsOfChild, $ as Shape, a0 as LabelListFromLabelProp, a1 as isNumber, a2 as mathSign, a3 as svgPropertiesNoEventsFromUnknown, a4 as polarToCartesian, a5 as getMaxRadius, a6 as getPercentValue, a7 as Curve, a8 as getClassNameFromUnknown, a9 as Text, aa as useAppDispatch, ab as updatePolarOptions, ac as RechartsStoreProvider, ad as ChartDataContextProvider, ae as ReportMainChartProps, af as ReportEventSettings, ag as ReportChartProps, ah as CategoricalChart, ai as initialEventSettingsState, aj as arrayTooltipSearcher, ak as ResponsiveContainer, al as Tooltip } from "./CategoricalChart-BygurfAn.js";
...
function CrisisInsights() {
  ...
  const { total, hospital, daysAffected, types, triggers } = reactExports.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MobileAppShell, { hideNav: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubPageHeader, { title: "Crisis Insights", back: "/crisis" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 p-1 bg-muted rounded-full mb-6", children: ["overview", "trends"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => setTab(t),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border/60 rounded-2xl p-3 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-2xl font-bold text-primary", children: s.n }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground font-semibold mt-1", children: s.l })
        ] }, s.l)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-foreground mb-3", children: "Crisis types" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border/60 rounded-2xl p-4 mb-6", children: types.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-4", children: "No data yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-32 h-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Pie, { data: types, dataKey: "value", innerRadius: 36, outerRadius: 56, paddingAngle: 2, children: types.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: COLORS[i % COLORS.length] }, i)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {})
          ] }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 space-y-2", children: types.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2.5 h-2.5 rounded-full", style: { background: COLORS[i % COLORS.length] } }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-foreground mb-3", children: "Common triggers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border/60 rounded-2xl px-4 py-2 mb-6", children: triggers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-4", children: "No triggers logged yet" }) : triggers.map(([name, count]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-b border-border/50 last:border-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground", children: name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-muted-foreground", children: count })
        ] }, name)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-accent/10 border border-accent/20 rounded-2xl p-4 mb-6 flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/80 leading-snug flex-1", children: "Share these insights with your care team to get better support." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "sm", variant: "outline", className: "border-accent text-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/crisis/share", children: "Share" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "xl", className: "w-full", onClick: handleDownload, children: [
