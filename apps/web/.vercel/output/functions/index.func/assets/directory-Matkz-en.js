...
import { b as useProfile, e as useGetProfile, u as useToast, H as useUpdateProvider, I as useUpdateProfile, J as useListProviders, K as getListProvidersQueryKey, L as getGetProfileQueryKey, M as useCreateProviderSuggestion } from "./AppRouter-B_BCS-Zy.js";
...
import { AddCircleLinear, MagniferLinear, GlobalLinear, BookmarkBold, BookmarkLinear, MapPointWaveLinear, CloseCircleLinear, CheckCircleBold, MapPointLinear, PhoneLinear, PhoneBold, ArrowRightUpLinear, UsersGroupTwoRoundedBold, UsersGroupTwoRoundedLinear, ChatRoundDotsBold, ChatRoundDotsLinear, TestTubeBold, TestTubeLinear, HospitalBold, HospitalLinear } from "solar-icon-set";
...
function Directory() {
  ...
  const getProviderIcon = (type) => {
    switch (type) {
      case "hospital":
        return { outline: HospitalLinear, filled: HospitalBold };
      case "lab":
        return { outline: TestTubeLinear, filled: TestTubeBold };
      case "counselling":
        return { outline: ChatRoundDotsLinear, filled: ChatRoundDotsBold };
      default:
        return { outline: UsersGroupTwoRoundedLinear, filled: UsersGroupTwoRoundedBold };
    }
  };
  const [suggestOpen, setSuggestOpen] = useState(false);
  return /* @__PURE__ */ jsxs(MobileAppShell, { children: [
    /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3 mb-6", children: [
        /* @__PURE__ */ jsx("h1", { className: "font-serif text-[1.5rem] text-primary font-semibold tracking-[-0.5px]", children: "Care Directory" }),
        /* @__PURE__ */ jsxs(
          Button,
          {
            variant: "outline",
            ...
            children: [
              /* @__PURE__ */ jsx(AddCircleLinear, { size: 14 }),
              " Suggest"
            ]
          }
        )
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative mb-3", children: [
        /* @__PURE__ */ jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 inline-flex text-muted-foreground", children: /* @__PURE__ */ jsx(MagniferLinear, { size: 16 }) }),
        /* @__PURE__ */ jsx(
          Input,
          {
      ...
      showLocationPrompt && /* @__PURE__ */ jsx(
        "div",
        {
          className: "mb-3 rounded-2xl bg-primary/5 border border-primary/15 p-4",
          "data-testid": "location-prompt",
          children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-primary/10 text-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(GlobalLinear, { size: 18 }) }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-primary leading-tight", children: "Tell us where you're based" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-1 leading-relaxed", children: "Pick your country (and optionally state) below — we'll save it to your profile and show local providers first." }),
            ...
            children: [
              /* @__PURE__ */ jsx(
                SelectTrigger,
                {
                  ...
                  children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Country" })
                }
              ),
              /* @__PURE__ */ jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsx(SelectItem, { value: ALL_COUNTRIES, children: "All countries" }),
                COUNTRIES.map((c) => /* @__PURE__ */ jsx(SelectItem, { value: c.name, children: c.name }, c.code))
              ] })
            ]
          }
        ),
            ...
            children: [
              /* @__PURE__ */ jsx(
                SelectTrigger,
                {
                  ...
                  children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "State / Region" })
                }
              ),
              /* @__PURE__ */ jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsx(SelectItem, { value: ALL_STATES, children: "All states" }),
                stateOptions.map((s) => /* @__PURE__ */ jsx(SelectItem, { value: s, children: s }, s))
              ] })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex gap-2 mb-2 flex-wrap", children: [
        ...
        /* @__PURE__ */ jsxs(
          Button,
          {
            ...
            children: [
              savedOnly ? /* @__PURE__ */ jsx(BookmarkBold, { size: 14 }) : /* @__PURE__ */ jsx(BookmarkLinear, { size: 14 }),
              "Saved"
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4 mt-2 gap-2", children: [
        locationStatus === "granted" && userCoords ? /* @__PURE__ */ jsxs(
          "span",
          {
            className: "inline-flex items-center gap-1 text-xs text-primary",
            "data-testid": "directory-location-active",
            children: [
              /* @__PURE__ */ jsx(MapPointWaveLinear, { size: 12 }),
              " Sorted by distance from you"
            ]
          }
        ) : locationStatus === "denied" ? /* @__PURE__ */ jsx(
          "span",
          {
        ...
        ) : locationStatus === "unsupported" ? /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground", children: "Location not supported on this device" }) : /* @__PURE__ */ jsxs(
          "button",
          {
            type: "button",
        ...
        filtersActive && /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(CloseCircleLinear, { size: 12 }),
              " Clear filters"
            ]
          }
        )
      ] }),
      isLoading ? /* @__PURE__ */ jsx("div", { className: "space-y-3", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsx(Card, { className: "border-none shadow-sm", children: /* @__PURE__ */ jsx(CardContent, { className: "p-5", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
      ...
      ] }) }) }, i)) }) : filteredProviders?.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-16 text-muted-foreground", children: [
        /* @__PURE__ */ jsx("div", { className: "flex justify-center mb-4 opacity-20", children: /* @__PURE__ */ jsx(MagniferLinear, { size: 48 }) }),
        /* @__PURE__ */ jsx("p", { className: "text-sm", "data-testid": "directory-empty", children: emptyMessage })
      ] }) : /* @__PURE__ */ jsx("div", { className: "space-y-3", children: filteredProviders?.map((provider) => {
            ...
            children: /* @__PURE__ */ jsxs(CardContent, { className: "p-5", children: [
              /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("div", { className: "w-11 h-11 rounded-xl bg-primary/10 text-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxs(
                      "span",
                      {
                        className: "relative inline-flex shrink-0",
                        style: { width: 22, height: 22 },
                        children: [
                          /* @__PURE__ */ jsx("span", { className: "absolute inset-0 transition-opacity duration-150 group-hover:opacity-0", children: /* @__PURE__ */ (() => {
                            const O = outline;
                            return /* @__PURE__ */ jsx(O, { size: 22 });
                          })() }),
                          /* @__PURE__ */ jsx("span", { className: "absolute inset-0 opacity-0 transition-opacity duration-150 group-hover:opacity-100", children: /* @__PURE__ */ (() => {
                            const F = filled;
                            return /* @__PURE__ */ jsx(F, { size: 22 });
                          })() })
                        ]
                      }
                    ) }),
                    /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-2 mb-1", children: [
                        /* @__PURE__ */ jsx("h3", { className: "font-semibold text-foreground text-sm leading-tight tracking-[-0.01em]", children: provider.name }),
                        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 shrink-0 mt-0.5", children: [
                          provider.verified && /* @__PURE__ */ jsx("span", { className: "text-green-600 inline-flex", children: /* @__PURE__ */ jsx(CheckCircleBold, { size: 16 }) }),
                          /* @__PURE__ */ jsx(
                            "button",
                            {
                              type: "button",
                              ...
                              children: provider.saved ? /* @__PURE__ */ jsx(BookmarkBold, { size: 18 }) : /* @__PURE__ */ jsx(BookmarkLinear, { size: 18 })
                            }
                          )
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground mb-1", children: [
                        /* @__PURE__ */ jsx("span", { className: "capitalize", children: provider.type }),
                        (provider.city || provider.state) && /* @__PURE__ */ jsxs(Fragment, { children: [
                          /* @__PURE__ */ jsx("span", { children: "•" }),
                          /* @__PURE__ */ jsx(MapPointLinear, { size: 12 }),
                          /* @__PURE__ */ jsx("span", { className: "line-clamp-1", children: [provider.city, provider.state].filter(Boolean).join(", ") })
                        ] })
                      ] }),
                      distanceKm != null && /* @__PURE__ */ jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsx(MapPointWaveLinear, { size: 11 }),
                            formatDistance(distanceKm)
                          ]
                        }
                      ),
                      provider.services && provider.services.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-1 mt-2", children: [
                        provider.services.slice(0, 2).map((service, idx) => /* @__PURE__ */ jsx(
                          "span",
                          {
                        ...
                        provider.services.length > 2 && /* @__PURE__ */ jsxs("span", { className: "text-[10px] bg-muted/40 px-2 py-0.5 rounded-md text-muted-foreground", children: [
                          "+",
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                /* @__PURE__ */ jsx(
                  Button,
                  {
                    ...
                    asChild: true,
                    children: /* @__PURE__ */ jsxs("a", { href: provider.phone ? `tel:${provider.phone}` : "#", children: [
                      /* @__PURE__ */ jsxs(
                        "span",
                        {
                          className: "relative inline-flex shrink-0",
                          ...
                          children: [
                            /* @__PURE__ */ jsx("span", { className: "absolute inset-0 transition-opacity duration-150 group-hover/btn:opacity-0", children: /* @__PURE__ */ jsx(PhoneLinear, { size: 14 }) }),
                            /* @__PURE__ */ jsx("span", { className: "absolute inset-0 opacity-0 transition-opacity duration-150 group-hover/btn:opacity-100", children: /* @__PURE__ */ jsx(PhoneBold, { size: 14 }) })
                          ]
                        }
                      ),
                      "Call"
...
function SuggestProviderDialog({
  ...
  return /* @__PURE__ */ jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-[400px] rounded-2xl", children: [
    /* @__PURE__ */ jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsx(DialogTitle, { className: "font-serif text-primary", children: "Suggest a provider" }),
      /* @__PURE__ */ jsx(DialogDescription, { className: "text-xs", children: "Help other families find clinics, counsellors, labs, and support groups you trust. We'll review before publishing." })
    ] }),
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-3", "data-testid": "suggest-form", children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsx(Label, { htmlFor: "suggest-name", className: "text-xs", children: "Name" }),
        /* @__PURE__ */ jsx(
          Input,
          {
            id: "suggest-name",
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxs(
          Select,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(SelectTrigger, { "data-testid": "suggest-type", children: /* @__PURE__ */ jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsx(SelectItem, { value: "hospital", children: "Hospital" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "counselling", children: "Counselling" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "lab", children: "Lab" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "support", children: "Support group" })
              ] })
            ]
          }
        )
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsx(Label, { className: "text-xs", children: "Country" }),
          /* @__PURE__ */ jsxs(
            Select,
            {
              value: country,
              ...
              children: [
                /* @__PURE__ */ jsx(SelectTrigger, { "data-testid": "suggest-country", children: /* @__PURE__ */ jsx(SelectValue, {}) }),
                /* @__PURE__ */ jsx(SelectContent, { children: COUNTRIES.map((c) => /* @__PURE__ */ jsx(SelectItem, { value: c.name, children: c.name }, c.code)) })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsx(Label, { className: "text-xs", children: "State / Region" }),
          /* @__PURE__ */ jsxs(
            Select,
            {
              ...
              children: [
                /* @__PURE__ */ jsx(SelectTrigger, { "data-testid": "suggest-state", children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Select" }) }),
                /* @__PURE__ */ jsxs(SelectContent, { children: [
                  /* @__PURE__ */ jsx(SelectItem, { value: "__none__", children: "—" }),
                  stateOpts.map((s) => /* @__PURE__ */ jsx(SelectItem, { value: s, children: s }, s))
                ] })
              ]
            }
          )
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "suggest-city", className: "text-xs", children: "City" }),
          /* @__PURE__ */ jsx(
            Input,
            {
              id: "suggest-city",
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "suggest-phone", className: "text-xs", children: "Phone" }),
          /* @__PURE__ */ jsx(
            Input,
            {
              id: "suggest-phone",
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxs(Label, { htmlFor: "suggest-about", className: "text-xs", children: [
          "Notes ",
