  ...
  return (
    <MobileAppShell hideNav>
              ...
              {[
                ...
                <Button 
                  ...
                  className={`h-12 rounded-xl text-sm font-medium transition-all ${
                    type === t.id 
                      ? "bg-primary text-primary-foreground border-primary shadow-md scale-[1.02] hover:bg-primary/90" 
      ...
      <Dialog open={showFeverAlert} onOpenChange={setShowFeverAlert}>
        <DialogContent className="w-[90vw] max-w-md rounded-[32px] p-8 border-none shadow-2xl bg-card text-foreground">
          <DialogHeader className="space-y-4">
            ...
            <DialogTitle className="text-2xl font-serif text-center text-destructive">
              Emergency Alert
            </DialogTitle>
            <DialogDescription className="text-base text-center leading-relaxed text-foreground">
              ...
              <br /><br />
              <span className="font-bold text-destructive">In Sickle Cell Disease, a fever is a medical emergency.</span>
              <br /><br />
