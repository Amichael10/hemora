        ...
        >
          ...
          <div className="relative">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Button size="lg" variant="glass" disabled className="opacity-70 cursor-not-allowed relative">
    ...
    <Section id="blog">
      <div className="px-6 sm:px-10 py-20 lg:py-28">
        <div className="max-w-2xl" data-reveal>
          <div className="text-xs uppercase tracking-[0.18em] text-accent font-semibold">From the Blog</div>
          <h2 className="mt-3 font-serif text-3xl sm:text-4xl lg:text-5xl text-secondary leading-tight">
            Stories & insights,<br />
            <span className="italic text-muted-foreground">written with care.</span>
          </h2>
          <p className="mt-5 text-muted-foreground leading-relaxed max-w-md">
            Family stories, care guides, and clear explainers on living well with sickle cell.
          </p>
          <div className="mt-7">
            <Button asChild size="lg" className="rounded-full">
              <a href="/blog">Read the blog <ArrowRight size={16} /></a>
            </Button>
          </div>
        </div>
